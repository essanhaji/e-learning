                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row text-center">
                            <label class="radio-inline"><input type="radio" value="teacher" name="role_id">Teacher</label>
                            <label class="radio-inline"><input type="radio" value="student" name="role_id" checked>Student</label>
                            @error('role_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-0 text-center">
                            <button type="submit" class="flat-button bg-orange">
                                {{ __('Register') }}
                            </button>
                        </div>
                    </form>
